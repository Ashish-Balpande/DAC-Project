	...
	<section class="contact" id="contact">
		...
		<div class="row">
			...
			<form action='<spring:url value="/User/contactus"/>' method="post">
				<div class="inputBox">
					<input type="text" name="name" placeholder="name"> <input type="email"
						name="email" placeholder="email">
				</div>
				<div class="inputBox">
					<input type="number" placeholder="number" name="mobile"> <input
						type="text" placeholder="subject">
				</div>
				<textarea placeholder="message" name="comment" id="" cols="30" rows="10"></textarea>
